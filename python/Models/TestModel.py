...
## TestModel.py
##
## Test model file for testing various aspects of C++/python
## communication.
##
#####################################################################

from . import ModelMain
from Errors import ErrorCodes

#=======#
# A model used to test the full data path of the bot/server, not used for
# generating any meaningful output.
#=======#
class TestModel(ModelMain.Model):
    ...
    #-------#
    # Just echo back the user input as well as a > 2000 char string.
    # param[in] lUserInput    Input string.
    #-------#
